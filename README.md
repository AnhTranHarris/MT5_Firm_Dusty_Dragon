...
Google OAuth client secrets and refresh tokens remain local runtime secrets and are excluded by `.gitignore`. The ChatGPT Google Drive connection is not reused by the running bot.
